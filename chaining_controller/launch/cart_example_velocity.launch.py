...
def generate_launch_description():
    ...
    xacro_file = os.path.join(chaining_controller_path, "urdf", "test_cart_velocity.xacro.urdf")
    ...
    load_imu_sensor_broadcaster = ExecuteProcess(
        cmd=["ros2", "control", "load_controller", "imu_sensor_broadcaster"], output="screen"
    )
